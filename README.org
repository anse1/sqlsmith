...
It currently supports generating queries for PostgreSQL, SQLite 3,
Redshift and MonetDB.  To add support for another RDBMS, you need to
implement two classes providing schema information about and
...
: # testing Redshift
: sqlsmith --verbose --target="host=redshift.cluster.com port=5439 dbname=regression"
...
| =--redshift=connstr= | target Redshift database (default: libpq defaults)       |
